	...
	<div class="row">
		<div class="col-lg-12 col-sm-12 col-md-12">
			...
			<shiro:hasRole name="admin">
				...
				<div class="pull-right"><a href="${ctx}/user/form" class="btn btn-primary">新增用户</a></div>
			</shiro:hasRole>
			<div class="pull-right"><a href="${ctx}/user/logout" class="btn btn-danger">退出系统</a></div>
			<table class="table table-hover table-bordered text-center">
				...
				<c:forEach items="${humans}" var="human">
					<tr>
						...
						<td>${human.remark}</td>
						<shiro:hasRole name="admin">
							<td><a href="${ctx}/user/edit/${human.id}" class="btn btn-primary btn-sm">修改</a>
								<a href="${ctx}/user/del/${human.id}" class="btn btn-danger btn-sm">删除</a></td>
						</shiro:hasRole>
					</tr>
				</c:forEach>
				</tbody>
